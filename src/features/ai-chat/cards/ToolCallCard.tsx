...
export const TOOL_META: Record<string, { label: string; icon: React.ReactNode; color: string }> = {
  ...
  get_ibkr_option_chain: { label: 'Loading Option Chain',  icon: <BarChart className="w-3.5 h-3.5" />,      color: 'text-purple-400 bg-purple-500/10 border-purple-500/20' },
  place_ibkr_option_order: { label: 'Placing Option Order',icon: <ArrowRight className="w-3.5 h-3.5" />,    color: 'text-purple-400 bg-purple-500/10 border-purple-500/20' },
