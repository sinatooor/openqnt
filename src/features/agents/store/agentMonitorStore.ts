...
const EMPTY_EVENTS: readonly StreamEvent[] = Object.freeze([]) as readonly StreamEvent[];
export const selectRunEvents = (runId: string) => (s: Store): readonly StreamEvent[] =>
  s.eventsByRun[runId] ?? EMPTY_EVENTS;
