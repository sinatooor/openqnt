...
Blockly.Blocks['ta_cci'] = {
    init: function () {
        this.appendDummyInput()
            ...
            .appendField("TF:").appendField(new Blockly.FieldDropdown(TIMEFRAME_OPTIONS), "PERIOD").appendField(createGearSettingsButton('cci'));
        this.setOutput(true, "TAValue");
        this.setStyle('ta_blocks');
        this.setTooltip("Commodity Channel Index");
        this.indicatorName = 'cci';
        this.indicatorParams = getDefaultParams('cci');
