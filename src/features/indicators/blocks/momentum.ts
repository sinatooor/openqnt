...
Blockly.Blocks['momentum'] = {
    init: function () {
        this.appendDummyInput()
            ...
            .appendField("TF:").appendField(new Blockly.FieldDropdown(TIMEFRAME_OPTIONS), "PERIOD").appendField(createGearSettingsButton('momentum'));
        this.setOutput(true, "TAValue");
        this.setStyle('ta_blocks');
        this.setTooltip("Momentum");
        this.indicatorName = 'momentum';
        this.indicatorParams = getDefaultParams('momentum');
