...
Blockly.Blocks['ta_lwma'] = {
    init: function () {
        this.appendDummyInput()
            ...
            .appendField("TF:").appendField(new Blockly.FieldDropdown(TIMEFRAME_OPTIONS), "PERIOD").appendField(createGearSettingsButton('lwma'));
        this.setOutput(true, "TAValue");
        this.setStyle('ta_blocks');
        this.setTooltip("Linear Weighted Moving Average");
        this.indicatorName = 'lwma';
        this.indicatorParams = getDefaultParams('lwma');
