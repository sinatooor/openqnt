...
Blockly.Blocks['force'] = {
    init: function () {
        this.appendDummyInput()
            ...
            .appendField("TF:").appendField(new Blockly.FieldDropdown(TIMEFRAME_OPTIONS), "PERIOD").appendField(createGearSettingsButton('force'));
        this.setOutput(true, "TAValue");
        this.setStyle('ta_blocks');
        this.setTooltip("Force Index");
        this.indicatorName = 'force';
        this.indicatorParams = getDefaultParams('force');
