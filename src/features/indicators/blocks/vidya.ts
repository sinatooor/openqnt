...
Blockly.Blocks['vidya'] = {
    init: function () {
        this.appendDummyInput()
            ...
            .appendField("TF:").appendField(new Blockly.FieldDropdown(TIMEFRAME_OPTIONS), "PERIOD").appendField(createGearSettingsButton('vidya'));
        this.setOutput(true, "TAValue");
        this.setStyle('ta_blocks');
        this.setTooltip("Variable Index Dynamic Average");
        this.indicatorName = 'vidya';
        this.indicatorParams = getDefaultParams('vidya');
