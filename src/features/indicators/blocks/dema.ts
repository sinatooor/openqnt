...
Blockly.Blocks['dema'] = {
    init: function () {
        this.appendDummyInput()
            ...
            .appendField("TF:").appendField(new Blockly.FieldDropdown(TIMEFRAME_OPTIONS), "PERIOD").appendField(createGearSettingsButton('dema'));
        this.setOutput(true, "TAValue");
        this.setStyle('ta_blocks');
        this.setTooltip("Double Exponential Moving Average");
        this.indicatorName = 'dema';
        this.indicatorParams = getDefaultParams('dema');
