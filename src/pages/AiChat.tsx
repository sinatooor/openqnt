...
const AiChat = ({ defaultMode, defaultFilter }: Props = {}) => {
  ...
  return (
    <div className="h-screen bg-background flex flex-col pt-14 overflow-hidden">
      {/* Fixed-height row so children can install their own overflow-y-auto
          (sidebar list, message list) without the whole page scrolling. */}
