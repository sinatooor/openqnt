/**
 * TerminalRmap Page — the Bloomberg RMAP (Relationship Map) function.
 *
 * URL: /terminal/rmap  or  /terminal/rmap/:ticker
 *
 * A ticker can also be supplied via ?ticker=AAPL for convenience.
 */
...
export default function TerminalRmap() {
  ...
  const submit = useMemo(
    () => (value: string) => {
      ...
      if (!clean) return;
      setTicker(clean);
      navigate(`/terminal/rmap/${encodeURIComponent(clean)}`, { replace: true });
    },
    [navigate],
  );
          ...
          <div className="w-full max-w-none space-y-2 p-4 md:p-6">
            ...
            <div className="terminal-commandbar flex flex-wrap items-center gap-2 px-3 py-1.5">
              ...
              <div className="ml-auto flex items-center gap-2">
                ...
                <span className="font-mono text-[10px] text-amber-400">P164</span>
              </div>
            </div>
