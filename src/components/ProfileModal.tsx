...
export const ProfileModal = ({
    ...
    const handleLogin = () => {
        if (loginName.trim() && loginEmail.trim()) {
            login(loginName.trim(), loginEmail.trim());
            setLoginName('');
            setLoginEmail('');
        }
    };
    ...
    const brokers = [
        ...
        { id: 'robinhood', name: 'Robinhood', description: 'Commission-Free Trading', logo: '/logo/logo_robinhood.png', status: 'disconnected' },
        { id: 'webull', name: 'Webull', description: 'Advanced Trading', logo: '/logo/logo_webull.png', status: 'disconnected' },
        { id: 'interactivebrokers', name: 'Interactive Brokers', description: 'Global Trading', logo: '/logo/interactivebrokers.png', status: 'disconnected' },
        { id: 'schwab', name: 'Charles Schwab', description: 'Investment Services', logo: '/logo/schwab.png', status: 'disconnected' },
        { id: 'etrade', name: 'E*TRADE', description: 'Online Trading', logo: '/logo/etrade.png', status: 'disconnected' },
        { id: 'saxo', name: 'Saxo Bank', description: 'Multi-Asset Trading', logo: '/logo/saxo.png', status: 'disconnected' },
        { id: 'swissquote', name: 'Swissquote', description: 'Banking & Trading', logo: '/logo/swissquote.png', status: 'disconnected' },
        { id: 'scandinavian', name: 'Scandinavian Capital', description: 'Forex Trading', logo: '/logo/scandinaviancapitalmarkets.png', status: 'disconnected' },
        { id: 'avanza', name: 'Avanza', description: 'Swedish Broker', logo: '/logo/avanza.png', status: 'disconnected' },
        { id: 'nordnet', name: 'Nordnet', description: 'Nordic Broker', logo: '/logo/nordnet.png', status: 'disconnected' },
        { id: 'swedbank', name: 'Swedbank', description: 'Banking & Trading', logo: '/logo/swedbank.png', status: 'disconnected' },
        { id: 'seb', name: 'SEB', description: 'Financial Services', logo: '/logo/seb.png', status: 'disconnected' },
        { id: 'handelsbanken', name: 'Handelsbanken', description: 'Banking & Trading', logo: '/logo/handelsbanken.png', status: 'disconnected' },
        { id: 'nordea', name: 'Nordea', description: 'Financial Services', logo: '/logo/nordea.png', status: 'disconnected' },
    ];

    const handleConnect = (name: string) => {
        const text = `Connect ${name}`;
        navigator.clipboard.writeText(text);
        onClose(); // Close modal
        // Trigger AI chat open via props if available, or just rely on user manual open for MVP
        // Since we don't have onRequestAIChat prop yet, we rely on toast instruction
        // Ideally we should pass onRequestAIChat prop.
        const event = new CustomEvent('openAIChat', { detail: { message: text } });
